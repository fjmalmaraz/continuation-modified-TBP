...
def calculate_initialsolution(system,nconf,nbody,datafile):
  ...
  file=open("nbp_constants_potential.h","w")
  ...
  subprocess.check_call(["gfortran","-c","nbp_potential.f90"])
  subprocess.check_call(["gfortran","-o","orbcalc.exe","orbcalc.f90","nbp_potential.f90"])
